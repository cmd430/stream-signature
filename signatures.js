module.exports = [
  ...
  },
  {
    ...
    signatures: [
      ...
      [0, Buffer.from([0xFF, 0xD8, 0xFF, 0xED, 0x28, 0x84, 0x50, 0x68, 0x6F, 0x74, 0x6F, 0x73, 0x68, 0x6F, 0x70])]
    ]
  },
  {
    extensions: [ 'png' ],
  ...
  },
  {
    ...
    signatures: [
      ...
      [4, Buffer.from([ 0x66, 0x74, 0x79, 0x70 ]), 8, Buffer.from([ 0x69, 0x73, 0x6F, 0x35 ])],
      [4, Buffer.from([ 0x66, 0x74, 0x79, 0x70 ]), 8, Buffer.from([ 0x69, 0x73, 0x6F, 0x6D ])],
      [4, Buffer.from([ 0x66, 0x74, 0x79, 0x70 ]), 8, Buffer.from([ 0x4D, 0x53, 0x4E, 0x56 ])],
